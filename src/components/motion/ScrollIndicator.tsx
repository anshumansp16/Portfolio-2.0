  ...
  return (
    ...
    >
      ...
      <div className="relative w-px h-16 bg-graphite/30 overflow-hidden">
        <motion.div
          className="absolute w-full h-8 bg-gradient-to-b from-transparent via-accent-electric to-transparent"
          animate={{
            y: ['-100%', '200%'],
          }}
          transition={{
      ...
      {/* Arrow */}
      <motion.svg
        className="w-4 h-4 text-graphite group-hover:text-accent-electric transition-colors duration-300"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
        animate={{
